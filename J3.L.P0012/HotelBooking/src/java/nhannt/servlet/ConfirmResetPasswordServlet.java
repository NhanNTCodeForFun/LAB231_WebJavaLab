...
public class ConfirmResetPasswordServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String newPassword = request.getParameter("key2");
        ...
        try  {
            ...
            boolean rs = userInforDAO.confirmPassword(username, newPassword);
            if(!rs)
            {
                request.setAttribute("invalidLink", "Your Link Is Invalid!");
            } else
            {
                request.setAttribute("success", "Reset Password Successful!");
            }
            session.invalidate();
