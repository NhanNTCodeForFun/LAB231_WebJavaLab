...
<html>
    ...
    <body>
        ...
        <a href="DispatchController?btAction=Home">Back to Home Page</a>
        ...
        <div>
            ...
            <c:if test="${post.isYourPost}">
                <a href="DispatchController?btAction=DeletePost&txtPostId=${post.postDTO.postId}" onclick="return confirm('Are you sure you want to delete this post?');">Delete Post</a><br/>
            </c:if>
            ${post.like} 
            ...
            <div>
                <c:forEach var="comment" items="${post.commentList}">
                    ...
                    <c:if test="${comment.isYourComment}">
                        <a href="DispatchController?btAction=DeleteComment&txtPostId=${post.postDTO.postId}&txtCommentId=${comment.commentDTO.commentId}" onclick="return confirm('Are you sure you want to delete this comment?');">Delete Comment</a>
                        <br/>
                    </c:if>
                </c:forEach>
            </div>
