...
public class ShowPostServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String page = request.getParameter("btPage");
        HttpSession session = request.getSession();
        String isSearch = (String) session.getAttribute("IS_SEARCH");
        ...
        try {
            ...
            if (isSearch.equals("true")) {
                ...
                listResult = postDAO.getSearchPostPage(page, searchValue);

            } else {
                listResult = postDAO.getAllPostPage(page);
            }
            for (PostDTO postDTO : listResult) {
                ...
                listPost.add(new Post(name, postDTO, like, dislike, comment, null, isYourPost));
